...
(function (factory) {
    ...
    function Plugin(options) {
        return this.each(function () {
            var self = $(this);
            self.empty();
            self.options = $.extend({}, { optionsText: "text", optionsValue: "id", isDefault: true, placeholder: "--请选择--", defaultValue: null, isEnable: true, ready: null }, (!options ? self.data("parms") : options) || {});
